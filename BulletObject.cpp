...
bool BulletObject::LoadImgBullet(SDL_Renderer* des)
{
	...
	{
		ret =LoadImage("IMG/sphere_bullet.png", des);
	}
	else if(bullet_type_== LASER_BULLET)
	{
		ret= LoadImage("IMG/laze_bullet.png", des);
	}
    else if (bullet_type_ == FIRE_BULLET)
    {
        ret = LoadImage("IMG/fireball_bullet_left.png", des);
    }
    else if (bullet_type_ == CHIDORI_BULLET)
    {
        ret = LoadImage("IMG/chidori_bullet.png", des);
    }
